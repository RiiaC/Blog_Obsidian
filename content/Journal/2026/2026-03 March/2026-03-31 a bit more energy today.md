...
After he got home,  we started cutting the first two bits of trim for the [[Create an attic bedroom|attic bathroom loo floor]]  then it was time for Reengarda officer meeting. Still no decision on if/where we will move  storage, but before the next meeting we need to go to the existing storage and measure it.
...
Previous post: [[2026-03-30 tent washing]]