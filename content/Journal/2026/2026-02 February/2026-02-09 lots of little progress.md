...
Then I started filling in  the first layer spackel where we  lost a bit of the guest room ceiling when the electrician drilled down from the closet above to send wires through.  That spot will take a number of layers before it looks reasonable. 
...
Previous post: [[2026-02-08 really deep sleep]]