...
tags:
---
During our morning phone call, I did some test painting in the moring to see if it works to paint over the foam I am using in the [[Camping loo]] to keep the chamber pot in place, or, if, perhaps, we should fill the holes with wet-room spackel first. Nope. We should not. Keldor suggested we also check with some latex grout stuff, but that will need to be purchased, so the project is again on hold.
